...
This is a description to boost you into a install of vanilla Kubernetes on Linux, in this case Ubuntu.
...
# Make sure to comment out this line in /etc/fstab so swap is turned off after reboot aswell
...
# install kubelet, kubeadm, and kubectl at version 1.33.5-1.1
